...
**Description:** When true, adds the CDK execution role as a Lake Formation admin so CDK
...
## <a name="createDataZoneAdminRole"></a>2. Property `root > createDataZoneAdminRole`
...
**Description:** When true, creates a dedicated Lake Formation admin role for DataZone
...
## <a name="crossAccountVersion"></a>3. Property `root > crossAccountVersion`
...
**Description:** Lake Formation cross-account sharing version. Controls which cross-account
...
## <a name="dataZoneAdminTrustAccounts"></a>4. Property `root > dataZoneAdminTrustAccounts`
...
**Description:** Additional account IDs added to the DataZone admin role's trust policy,
...
| --------------------------------------------------------------------- | ----------- |
| [dataZoneAdminTrustAccounts items](#dataZoneAdminTrustAccounts_items) | -           |

### <a name="dataZoneAdminTrustAccounts_items"></a>4.1. root > dataZoneAdminTrustAccounts > dataZoneAdminTrustAccounts items
...
## <a name="iamAllowedPrincipalsDefault"></a>5. Property `root > iamAllowedPrincipalsDefault`
...
**Description:** Controls whether IAM_ALLOWED_PRINCIPALS is added by default to new databases
...
## <a name="iamIdentityCenter"></a>6. Property `root > iamIdentityCenter`
...
| **Required**              | No                                 |
| **Additional properties** | Not allowed                        |
| **Defined in**            | #/definitions/IdentityCenterConfig |

**Description:** IAM Identity Center integration for Lake Formation, enabling SSO-based
...
| Property                                       | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------------------------------- | ------- | --------------- | ---------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [instanceId](#iamIdentityCenter_instanceId ) | No      | string          | No         | -          | IAM Identity Center instance ID to integrate with Lake Formation.<br />This is the SSO instance that manages users and groups for data lake access.<br /><br />Use cases: SSO-based Lake Formation access; Centralized user/group management<br /><br />AWS: IAM Identity Center instance<br /><br />Validation: Required; valid Identity Center instance ID (e.g. "ssoins-...")             |
| - [shares](#iamIdentityCenter_shares )         | No      | array of string | No         | -          | Accounts, organizations, or OUs to share Lake Formation services with<br />via IAM Identity Center. Accepts account IDs, organization ARNs, and OU ARNs.<br /><br />Use cases: Cross-account Lake Formation sharing; Org-wide data governance via SSO<br /><br />AWS: RAM resource shares, IAM Identity Center<br /><br />Validation: Optional; array of account IDs or organization/OU ARNs |

### <a name="iamIdentityCenter_instanceId"></a>6.1. Property `root > iamIdentityCenter > instanceId`
...
**Description:** IAM Identity Center instance ID to integrate with Lake Formation.
...
### <a name="iamIdentityCenter_shares"></a>6.2. Property `root > iamIdentityCenter > shares`
...
**Description:** Accounts, organizations, or OUs to share Lake Formation services with
...
| Each item of this array must be                 | Description |
| ----------------------------------------------- | ----------- |
| [shares items](#iamIdentityCenter_shares_items) | -           |

#### <a name="iamIdentityCenter_shares_items"></a>6.2.1. root > iamIdentityCenter > shares > shares items
...
## <a name="lakeFormationAdminRoles"></a>7. Property `root > lakeFormationAdminRoles`
...
**Description:** Roles granted full Lake Formation administrator access including permission
...
| Each item of this array must be               | Description |
| --------------------------------------------- | ----------- |
| [MdaaRoleRef](#lakeFormationAdminRoles_items) | -           |

### <a name="lakeFormationAdminRoles_items"></a>7.1. root > lakeFormationAdminRoles > MdaaRoleRef
...
#### <a name="lakeFormationAdminRoles_items_id"></a>7.1.2. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > id`
...
#### <a name="lakeFormationAdminRoles_items_immutable"></a>7.1.3. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > immutable`
...
#### <a name="lakeFormationAdminRoles_items_name"></a>7.1.4. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > name`
...
#### <a name="lakeFormationAdminRoles_items_refId"></a>7.1.5. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > refId`
...
#### <a name="lakeFormationAdminRoles_items_sso"></a>7.1.6. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > sso`
