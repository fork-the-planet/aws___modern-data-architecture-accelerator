...
| + [session](#session )                                               | No      | object | No         | In #/definitions/MacieSessionProps                  | Macie session settings controlling finding publication frequency and session status.<br />Deploys a Macie session for automated sensitive data discovery and classification.<br /><br />Use cases: Sensitive data discovery automation; PII detection; Compliance monitoring<br /><br />AWS: Amazon Macie CfnSession<br /><br />Validation: Required; valid MacieSessionProps                                                                                                                                                                                                                                                                                                           |
...
## <a name="session"></a>4. Property `root > session`
...
| **Required**              | Yes                             |
| **Additional properties** | Not allowed                     |
| **Defined in**            | #/definitions/MacieSessionProps |

**Description:** Macie session settings controlling finding publication frequency and session status.
...
| Property                                                             | Pattern | Type             | Deprecated | Definition                                             | Title/Description                                                                                                                                                                                                                                                                                                                                |
| -------------------------------------------------------------------- | ------- | ---------------- | ---------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| + [findingPublishingFrequency](#session_findingPublishingFrequency ) | No      | enum (of string) | No         | In #/definitions/SessionFindingPublishingFrequencyEnum | How often Macie publishes findings about sensitive data discovery.<br /><br />Use cases: Near-real-time alerting (FIFTEEN_MINUTES); Balanced reporting (ONE_HOUR); Low-frequency summaries (SIX_HOURS)<br /><br />AWS: Amazon Macie session findingPublishingFrequency<br /><br />Validation: Required; FIFTEEN_MINUTES \| ONE_HOUR \| SIX_HOURS |
| - [status](#session_status )                                         | No      | enum (of string) | No         | -                                                      | Whether the Macie session is actively monitoring or paused.<br /><br />Use cases: Pause monitoring during maintenance; Resume after onboarding<br /><br />AWS: Amazon Macie session status<br /><br />Validation: Optional; ENABLED \| PAUSED                                                                                                    |

### <a name="session_findingPublishingFrequency"></a>4.1. Property `root > session > findingPublishingFrequency`

|                |                                                     |
| -------------- | --------------------------------------------------- |
| **Type**       | `enum (of string)`                                  |
| **Required**   | Yes                                                 |
| **Defined in** | #/definitions/SessionFindingPublishingFrequencyEnum |

**Description:** How often Macie publishes findings about sensitive data discovery.
...
### <a name="session_status"></a>4.2. Property `root > session > status`
...
**Description:** Whether the Macie session is actively monitoring or paused.
