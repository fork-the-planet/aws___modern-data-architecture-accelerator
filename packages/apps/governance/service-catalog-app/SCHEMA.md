...
| + [portfolios](#portfolios )                                         | No      | object | No         | -                                                   | Map of portfolio names to portfolio configurations.<br />Each entry creates a Service Catalog portfolio with optional role-based access.<br /><br />Use cases: Multi-portfolio governance; Self-service infrastructure provisioning<br /><br />AWS: Service Catalog portfolios with principal associations<br /><br />Validation: Required; keys are portfolio display names, values must be valid PortfolioConfig                                                                                                                                                                                                                                                                      |
...
## <a name="portfolios"></a>2. Property `root > portfolios`

|                           |                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                |
| **Required**              | Yes                                                                                     |
| **Additional properties** | [Each additional property must conform to the schema](#portfolios_additionalProperties) |

**Description:** Map of portfolio names to portfolio configurations.
...
| Property                                | Pattern | Type   | Deprecated | Definition                       | Title/Description                                                                                                                                                                                                                                                                                                                                            |
| --------------------------------------- | ------- | ------ | ---------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| - [](#portfolios_additionalProperties ) | No      | object | No         | In #/definitions/PortfolioConfig | Service Catalog portfolio configuration with provider info and role-based access.<br /><br />Use cases: Self-service infrastructure provisioning; Governed product catalogs; Role-based portfolio access<br /><br />AWS: Service Catalog portfolio with principal associations<br /><br />Validation: providerName required; description and access optional |

### <a name="portfolios_additionalProperties"></a>2.1. Property `root > portfolios > PortfolioConfig`
...
| **Required**              | No                            |
| **Additional properties** | Not allowed                   |
| **Defined in**            | #/definitions/PortfolioConfig |

**Description:** Service Catalog portfolio configuration with provider info and role-based access.
...
| Property                                                         | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                     |
| ---------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [access](#portfolios_additionalProperties_access )             | No      | array  | No         | -          | Roles granted access to this portfolio for product provisioning.<br />Creates IAM principal associations on the portfolio.<br /><br />Use cases: Role-based portfolio access; Controlled product provisioning<br /><br />AWS: Service Catalog portfolio principal associations (IAM type)<br /><br />Validation: Optional; array of valid MdaaRoleRef |
| - [description](#portfolios_additionalProperties_description )   | No      | string | No         | -          | Portfolio description for users to understand contents and purpose.<br /><br />Use cases: Portfolio documentation; User guidance<br /><br />AWS: Service Catalog portfolio description<br /><br />Validation: Optional; string                                                                                                                        |
| + [providerName](#portfolios_additionalProperties_providerName ) | No      | string | No         | -          | Organization or team name responsible for this portfolio's products.<br /><br />Use cases: Portfolio ownership identification; Provider accountability<br /><br />AWS: Service Catalog portfolio provider name<br /><br />Validation: Required; non-empty string                                                                                      |

#### <a name="portfolios_additionalProperties_access"></a>2.1.1. Property `root > portfolios > additionalProperties > access`
...
**Description:** Roles granted access to this portfolio for product provisioning.
...
| Each item of this array must be                              | Description |
| ------------------------------------------------------------ | ----------- |
| [MdaaRoleRef](#portfolios_additionalProperties_access_items) | -           |

##### <a name="portfolios_additionalProperties_access_items"></a>2.1.1.1. root > portfolios > additionalProperties > access > MdaaRoleRef
...
###### <a name="portfolios_additionalProperties_access_items_id"></a>2.1.1.1.2. Property `root > portfolios > additionalProperties > access > access items > id`
...
###### <a name="portfolios_additionalProperties_access_items_immutable"></a>2.1.1.1.3. Property `root > portfolios > additionalProperties > access > access items > immutable`
...
###### <a name="portfolios_additionalProperties_access_items_name"></a>2.1.1.1.4. Property `root > portfolios > additionalProperties > access > access items > name`
...
###### <a name="portfolios_additionalProperties_access_items_refId"></a>2.1.1.1.5. Property `root > portfolios > additionalProperties > access > access items > refId`
...
###### <a name="portfolios_additionalProperties_access_items_sso"></a>2.1.1.1.6. Property `root > portfolios > additionalProperties > access > access items > sso`
...
#### <a name="portfolios_additionalProperties_description"></a>2.1.2. Property `root > portfolios > additionalProperties > description`
...
**Description:** Portfolio description for users to understand contents and purpose.
...
#### <a name="portfolios_additionalProperties_providerName"></a>2.1.3. Property `root > portfolios > additionalProperties > providerName`
...
**Description:** Organization or team name responsible for this portfolio's products.
...
| + [provisioningRole](#sagemakerBlueprint_provisioningRole )           | No      | object          | No         | Same as [portfolios_additionalProperties_access_items](#portfolios_additionalProperties_access_items ) | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| + [provisioningRole](#sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole )           | No      | object          | No         | Same as [portfolios_additionalProperties_access_items](#portfolios_additionalProperties_access_items ) | -                 |
...
| **Required**              | Yes                                                                                           |
| **Additional properties** | Not allowed                                                                                   |
| **Same definition as**    | [portfolios_additionalProperties_access_items](#portfolios_additionalProperties_access_items) |
