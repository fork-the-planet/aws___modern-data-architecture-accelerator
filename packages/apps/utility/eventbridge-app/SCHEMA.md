...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [eventBuses](#eventBuses )                                         | No      | object | No         | In #/definitions/NamedEventBusProps                 | Map of event bus names to EventBridge event bus configurations.<br />Each bus can have optional principals for cross-account/service PutEvent access<br />and an archive with configurable retention.<br /><br />Use cases: Custom event routing; Cross-account event publishing; Event archival with replay<br /><br />AWS: EventBridge custom event buses with resource policies and archives<br /><br />Validation: Required; keys are unique event bus names, values must be valid EventBusProps                                                                                                                                                                                    |
...
## <a name="eventBuses"></a>1. Property `root > eventBuses`

|                           |                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                |
| **Required**              | Yes                                                                                     |
| **Additional properties** | [Each additional property must conform to the schema](#eventBuses_additionalProperties) |
| **Defined in**            | #/definitions/NamedEventBusProps                                                        |

**Description:** Map of event bus names to EventBridge event bus configurations.
...
| Property                                | Pattern | Type   | Deprecated | Definition                     | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------- | ------- | ------ | ---------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [](#eventBuses_additionalProperties ) | No      | object | No         | In #/definitions/EventBusProps | Custom EventBridge event bus configuration with access control and archive retention.<br />Principals are granted PutEvent access via resource policy.<br />An event archive is automatically created for each bus.<br /><br />Use cases: Custom event bus with cross-account publishing; Event archival for replay and debugging<br /><br />AWS: EventBridge custom event bus with resource policy and event archive<br /><br />Validation: All properties optional; archiveRetention must be positive integer (days) |

### <a name="eventBuses_additionalProperties"></a>1.1. Property `root > eventBuses > EventBusProps`
...
| **Required**              | No                          |
| **Additional properties** | Not allowed                 |
| **Defined in**            | #/definitions/EventBusProps |

**Description:** Custom EventBridge event bus configuration with access control and archive retention.
...
| Property                                                                 | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------ | ------- | ------ | ---------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [archiveRetention](#eventBuses_additionalProperties_archiveRetention ) | No      | number | No         | -          | Number of days to retain events in the automatically created archive.<br />Enables event replay for debugging and recovery.<br /><br />Use cases: Event replay; Historical event analysis; Compliance retention<br /><br />AWS: EventBridge event archive retention period<br /><br />Validation: Optional; positive integer representing days                                     |
| - [principals](#eventBuses_additionalProperties_principals )             | No      | array  | No         | -          | Principals authorized to publish events to this bus via resource policy.<br />Each entry must specify exactly one of arn or service.<br /><br />Use cases: Cross-account event publishing; AWS service event integration<br /><br />AWS: EventBridge event bus resource policy principals (PutEvent access)<br /><br />Validation: Optional; array of valid EventBusPrincipalProps |

#### <a name="eventBuses_additionalProperties_archiveRetention"></a>1.1.1. Property `root > eventBuses > additionalProperties > archiveRetention`
...
**Description:** Number of days to retain events in the automatically created archive.
...
#### <a name="eventBuses_additionalProperties_principals"></a>1.1.2. Property `root > eventBuses > additionalProperties > principals`
...
**Description:** Principals authorized to publish events to this bus via resource policy.
...
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [EventBusPrincipalProps](#eventBuses_additionalProperties_principals_items) | Principal authorized to publish events to a custom EventBridge event bus. ... |

##### <a name="eventBuses_additionalProperties_principals_items"></a>1.1.2.1. root > eventBuses > additionalProperties > principals > EventBusPrincipalProps
...
| **Required**              | No                                   |
| **Additional properties** | Not allowed                          |
| **Defined in**            | #/definitions/EventBusPrincipalProps |

**Description:** Principal authorized to publish events to a custom EventBridge event bus.
...
| Property                                                                | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [arn](#eventBuses_additionalProperties_principals_items_arn )         | No      | string | No         | -          | IAM principal ARN for cross-account event publishing access.<br />Mutually exclusive with service.<br /><br />Use cases: Cross-account event bus access; Specific IAM role/user event publishing<br /><br />AWS: IAM principal ARN for EventBridge resource policy<br /><br />Validation: Optional; must be valid IAM principal ARN; mutually exclusive with service                                |
| - [service](#eventBuses_additionalProperties_principals_items_service ) | No      | string | No         | -          | AWS service principal name for service-based event publishing access<br />(e.g. some-service.amazonaws.com). Mutually exclusive with arn.<br /><br />Use cases: AWS service event integration; Service-to-bus event routing<br /><br />AWS: AWS service principal for EventBridge resource policy<br /><br />Validation: Optional; must be valid AWS service principal; mutually exclusive with arn |

###### <a name="eventBuses_additionalProperties_principals_items_arn"></a>1.1.2.1.1. Property `root > eventBuses > additionalProperties > principals > principals items > arn`
...
**Description:** IAM principal ARN for cross-account event publishing access.
...
###### <a name="eventBuses_additionalProperties_principals_items_service"></a>1.1.2.1.2. Property `root > eventBuses > additionalProperties > principals > principals items > service`
...
**Description:** AWS service principal name for service-based event publishing access
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_arn"></a>3.1.1.5.1. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > arn`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_id"></a>3.1.1.5.2. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > id`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_immutable"></a>3.1.1.5.3. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > immutable`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_name"></a>3.1.1.5.4. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > name`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_refId"></a>3.1.1.5.5. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > refId`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_sso"></a>3.1.1.5.6. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > sso`
