...
| - [dashboards](#dashboards )                                         | No      | array  | No         | -                                                   | CloudWatch dashboard definitions for observability and monitoring.<br />Dashboards can reference metrics from other modules via SSM parameters.<br /><br />Use cases: Unified observability; Cross-module metric aggregation<br /><br />AWS: CloudWatch dashboards<br /><br />Validation: Optional; array of DashboardProps                                                                                                                                                                                                                                                                                                                                                             |
...
| - [projectName](#projectName )                                       | No      | string | No         | -                                                   | DataOps project name for dashboard resource organization.<br /><br />Use cases: Project integration; Resource coordination<br /><br />AWS: DataOps project reference<br /><br />Validation: Optional; must match an existing deployed project                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
## <a name="dashboards"></a>2. Property `root > dashboards`
...
**Description:** CloudWatch dashboard definitions for observability and monitoring.
...
| ----------------------------------- | ------------------------------------------------------------------------ |
| [DashboardProps](#dashboards_items) | CloudWatch dashboard configuration with name and widget definitions. ... |

### <a name="dashboards_items"></a>2.1. root > dashboards > DashboardProps
...
| **Required**              | No                           |
| **Additional properties** | Not allowed                  |
| **Defined in**            | #/definitions/DashboardProps |

**Description:** CloudWatch dashboard configuration with name and widget definitions.
...
| Property                                            | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                           |
| --------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [dashboardName](#dashboards_items_dashboardName ) | No      | string | No         | -          | Unique name for the CloudWatch dashboard within the account/region.<br /><br />Use cases: Dashboard identification; Console navigation<br /><br />AWS: CloudWatch dashboard name<br /><br />Validation: Required; unique within account/region                                                                              |
| + [widgets](#dashboards_items_widgets )             | No      | array  | No         | -          | Widget definitions for metrics, logs, or text content.<br />Widgets auto-layout with wrapping at 24-unit width.<br /><br />Use cases: Metric visualization; Log query results; Dashboard organization<br /><br />AWS: CloudWatch dashboard widgets<br /><br />Validation: Required; non-empty array of DashboardWidgetProps |

#### <a name="dashboards_items_dashboardName"></a>2.1.1. Property `root > dashboards > dashboards items > dashboardName`
...
**Description:** Unique name for the CloudWatch dashboard within the account/region.
...
#### <a name="dashboards_items_widgets"></a>2.1.2. Property `root > dashboards > dashboards items > widgets`
...
**Description:** Widget definitions for metrics, logs, or text content.
...
| Each item of this array must be                         | Description                            |
| ------------------------------------------------------- | -------------------------------------- |
| [DashboardWidgetProps](#dashboards_items_widgets_items) | Properties for a dashboard widget. ... |

##### <a name="dashboards_items_widgets_items"></a>2.1.2.1. root > dashboards > dashboards items > widgets > DashboardWidgetProps
...
| **Required**              | No                                 |
| **Additional properties** | Not allowed                        |
| **Defined in**            | #/definitions/DashboardWidgetProps |

**Description:** Properties for a dashboard widget.
...
| Property                                                          | Pattern | Type             | Deprecated | Definition | Title/Description                                                                                                                            |
| ----------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| - [height](#dashboards_items_widgets_items_height )               | No      | number           | No         | -          | Height of the widget                                                                                                                         |
| - [logGroupNames](#dashboards_items_widgets_items_logGroupNames ) | No      | array of string  | No         | -          | Log group names for log insights widgets.<br />Use SSM references with {{org}}, {{domain}} placeholders which are resolved by config parser. |
| - [markdown](#dashboards_items_widgets_items_markdown )           | No      | string           | No         | -          | Markdown content for text widgets                                                                                                            |
| - [metrics](#dashboards_items_widgets_items_metrics )             | No      | array            | No         | -          | Metrics to display (for metric widgets)                                                                                                      |
| - [period](#dashboards_items_widgets_items_period )               | No      | number           | No         | -          | Period for metric widgets in seconds                                                                                                         |
| - [queryString](#dashboards_items_widgets_items_queryString )     | No      | string           | No         | -          | Query string for log insights widgets                                                                                                        |
| - [title](#dashboards_items_widgets_items_title )                 | No      | string           | No         | -          | The title of the widget                                                                                                                      |
| + [type](#dashboards_items_widgets_items_type )                   | No      | enum (of string) | No         | -          | The type of widget                                                                                                                           |
| - [width](#dashboards_items_widgets_items_width )                 | No      | number           | No         | -          | Width of the widget (1-24)                                                                                                                   |

###### <a name="dashboards_items_widgets_items_height"></a>2.1.2.1.1. Property `root > dashboards > dashboards items > widgets > widgets items > height`
...
###### <a name="dashboards_items_widgets_items_logGroupNames"></a>2.1.2.1.2. Property `root > dashboards > dashboards items > widgets > widgets items > logGroupNames`
...
**Description:** Log group names for log insights widgets.
...
| Each item of this array must be                                            | Description |
| -------------------------------------------------------------------------- | ----------- |
| [logGroupNames items](#dashboards_items_widgets_items_logGroupNames_items) | -           |

###### <a name="dashboards_items_widgets_items_logGroupNames_items"></a>2.1.2.1.2.1. root > dashboards > dashboards items > widgets > widgets items > logGroupNames > logGroupNames items
...
###### <a name="dashboards_items_widgets_items_markdown"></a>2.1.2.1.3. Property `root > dashboards > dashboards items > widgets > widgets items > markdown`
...
###### <a name="dashboards_items_widgets_items_metrics"></a>2.1.2.1.4. Property `root > dashboards > dashboards items > widgets > widgets items > metrics`
...
**Description:** Metrics to display (for metric widgets)
...
| Each item of this array must be                                       | Description                                        |
| --------------------------------------------------------------------- | -------------------------------------------------- |
| [DashboardMetricProps](#dashboards_items_widgets_items_metrics_items) | Properties for a metric in a dashboard widget. ... |

###### <a name="dashboards_items_widgets_items_metrics_items"></a>2.1.2.1.4.1. root > dashboards > dashboards items > widgets > widgets items > metrics > DashboardMetricProps
...
| **Required**              | No                                 |
| **Additional properties** | Not allowed                        |
| **Defined in**            | #/definitions/DashboardMetricProps |

**Description:** Properties for a metric in a dashboard widget.
...
| Property                                                                  | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                            |
| ------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| - [dimensions](#dashboards_items_widgets_items_metrics_items_dimensions ) | No      | object | No         | -          | Dimensions for the metric.                                                                                                                                                                                                                                   |
| - [expression](#dashboards_items_widgets_items_metrics_items_expression ) | No      | string | No         | -          | Metric math expression for calculations across metrics.<br />Example: "m1+m2+m3" to sum multiple metrics.<br />When using expressions, other metrics must have 'id' property set.                                                                            |
| - [id](#dashboards_items_widgets_items_metrics_items_id )                 | No      | string | No         | -          | ID for the metric (used in expressions)                                                                                                                                                                                                                      |
| - [label](#dashboards_items_widgets_items_metrics_items_label )           | No      | string | No         | -          | Label for the metric                                                                                                                                                                                                                                         |
| - [metricName](#dashboards_items_widgets_items_metrics_items_metricName ) | No      | string | No         | -          | Metric name. Required for regular metrics, optional for metric math expressions.<br />Can be a direct value or SSM reference with ssm: prefix.<br />Examples:<br />- Direct: "Errors"<br />- SSM: "ssm:/{{org}}/{{domain}}/module/metric/name"               |
| - [namespace](#dashboards_items_widgets_items_metrics_items_namespace )   | No      | string | No         | -          | Metric namespace. Required for regular metrics, optional for metric math expressions.<br />Can be a direct value or SSM reference with ssm: prefix.<br />Examples:<br />- Direct: "AWS/Lambda"<br />- SSM: "ssm:/{{org}}/{{domain}}/module/metric/namespace" |
| - [period](#dashboards_items_widgets_items_metrics_items_period )         | No      | number | No         | -          | Period for the metric in seconds                                                                                                                                                                                                                             |
| - [stat](#dashboards_items_widgets_items_metrics_items_stat )             | No      | string | No         | -          | Statistic to apply to the metric                                                                                                                                                                                                                             |
| - [unit](#dashboards_items_widgets_items_metrics_items_unit )             | No      | string | No         | -          | Unit of the metric                                                                                                                                                                                                                                           |

###### <a name="dashboards_items_widgets_items_metrics_items_dimensions"></a>2.1.2.1.4.1.1. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > dimensions`

|                           |                                                                                                                                      |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **Type**                  | `object`                                                                                                                             |
| **Required**              | No                                                                                                                                   |
| **Additional properties** | [Each additional property must conform to the schema](#dashboards_items_widgets_items_metrics_items_dimensions_additionalProperties) |
...
| Property                                                                             | Pattern | Type   | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------------------ | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#dashboards_items_widgets_items_metrics_items_dimensions_additionalProperties ) | No      | string | No         | -          | -                 |

###### <a name="dashboards_items_widgets_items_metrics_items_dimensions_additionalProperties"></a>2.1.2.1.4.1.1.1. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > dimensions > additionalProperties`
...
###### <a name="dashboards_items_widgets_items_metrics_items_expression"></a>2.1.2.1.4.1.2. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > expression`
...
**Description:** Metric math expression for calculations across metrics.
Example: "m1+m2+m3" to sum multiple metrics.
When using expressions, other metrics must have 'id' property set.

###### <a name="dashboards_items_widgets_items_metrics_items_id"></a>2.1.2.1.4.1.3. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > id`
...
**Description:** ID for the metric (used in expressions)

###### <a name="dashboards_items_widgets_items_metrics_items_label"></a>2.1.2.1.4.1.4. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > label`
...
###### <a name="dashboards_items_widgets_items_metrics_items_metricName"></a>2.1.2.1.4.1.5. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > metricName`
...
**Description:** Metric name. Required for regular metrics, optional for metric math expressions.
Can be a direct value or SSM reference with ssm: prefix.
Examples:
- Direct: "Errors"
- SSM: "ssm:/{{org}}/{{domain}}/module/metric/name"

###### <a name="dashboards_items_widgets_items_metrics_items_namespace"></a>2.1.2.1.4.1.6. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > namespace`
...
**Description:** Metric namespace. Required for regular metrics, optional for metric math expressions.
Can be a direct value or SSM reference with ssm: prefix.
Examples:
- Direct: "AWS/Lambda"
- SSM: "ssm:/{{org}}/{{domain}}/module/metric/namespace"

###### <a name="dashboards_items_widgets_items_metrics_items_period"></a>2.1.2.1.4.1.7. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > period`
...
**Description:** Period for the metric in seconds

###### <a name="dashboards_items_widgets_items_metrics_items_stat"></a>2.1.2.1.4.1.8. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > stat`
...
###### <a name="dashboards_items_widgets_items_metrics_items_unit"></a>2.1.2.1.4.1.9. Property `root > dashboards > dashboards items > widgets > widgets items > metrics > metrics items > unit`
...
###### <a name="dashboards_items_widgets_items_period"></a>2.1.2.1.5. Property `root > dashboards > dashboards items > widgets > widgets items > period`
...
**Description:** Period for metric widgets in seconds

###### <a name="dashboards_items_widgets_items_queryString"></a>2.1.2.1.6. Property `root > dashboards > dashboards items > widgets > widgets items > queryString`
...
**Description:** Query string for log insights widgets

###### <a name="dashboards_items_widgets_items_title"></a>2.1.2.1.7. Property `root > dashboards > dashboards items > widgets > widgets items > title`
...
###### <a name="dashboards_items_widgets_items_type"></a>2.1.2.1.8. Property `root > dashboards > dashboards items > widgets > widgets items > type`
...
###### <a name="dashboards_items_widgets_items_width"></a>2.1.2.1.9. Property `root > dashboards > dashboards items > widgets > widgets items > width`
...
**Description:** Width of the widget (1-24)
...
**Description:** DataOps project name for dashboard resource organization.
