...
| - [projectName](#projectName )                                       | No      | string | No         | -                                                   | DataOps project name for workflow resource autowiring.<br /><br />Use cases: Project integration; Resource coordination<br /><br />AWS: DataOps project reference<br /><br />Validation: Optional; must match an existing deployed project                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| + [workflowDefinitions](#workflowDefinitions )                       | No      | array  | No         | -                                                   | Glue workflow definitions for ETL pipeline orchestration and job coordination.<br /><br />Use cases: ETL pipeline sequencing; Trigger management; Conditional execution<br /><br />AWS: AWS Glue workflows<br /><br />Validation: Required; array of WorkflowProps                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
**Description:** DataOps project name for workflow resource autowiring.
...
## <a name="workflowDefinitions"></a>10. Property `root > workflowDefinitions`
...
**Description:** Glue workflow definitions for ETL pipeline orchestration and job coordination.
...
| Each item of this array must be             | Description                                                                                  |
| ------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [WorkflowProps](#workflowDefinitions_items) | Configuration for a Glue workflow with raw definition and optional EventBridge triggers. ... |

### <a name="workflowDefinitions_items"></a>10.1. root > workflowDefinitions > WorkflowProps
...
**Description:** Configuration for a Glue workflow with raw definition and optional EventBridge triggers.
...
| Property                                                       | Pattern | Type   | Deprecated | Definition                        | Title/Description                                                                                                                                                                                                                                                                                                                          |
| -------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| - [eventBridge](#workflowDefinitions_items_eventBridge )       | No      | object | No         | In #/definitions/EventBridgeProps | Optional EventBridge configuration for event-driven workflow triggers.<br /><br />Use cases: Event-driven workflows, S3 event triggers, scheduled execution<br /><br />AWS: Amazon EventBridge integration for Glue workflow triggers<br /><br />Validation: Must be valid EventBridgeProps if provided                                    |
| + [rawWorkflowDef](#workflowDefinitions_items_rawWorkflowDef ) | No      | object | No         | -                                 | Raw Glue workflow definition object (as exported from AWS CLI \`get-workflow\`).<br /><br />Use cases: ETL workflow definition, job orchestration, pipeline automation<br /><br />AWS: AWS Glue workflow definition with jobs, triggers, and dependencies<br /><br />Validation: Must be a valid Glue workflow definition object; required |

#### <a name="workflowDefinitions_items_eventBridge"></a>10.1.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge`
...
**Description:** Optional EventBridge configuration for event-driven workflow triggers.
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties"></a>10.1.1.1.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > EventBridgeRuleProps`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_description"></a>10.1.1.1.1.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > description`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventBusArn"></a>10.1.1.1.1.2. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventBusArn`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern"></a>10.1.1.1.1.3. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_account"></a>10.1.1.1.1.3.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > account`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_account_items"></a>10.1.1.1.1.3.1.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > account > account items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_detail"></a>10.1.1.1.1.3.2. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > detail`

|                           |                                                                                                                                                                              |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                                                                                                     |
| **Required**              | No                                                                                                                                                                           |
| **Additional properties** | [Each additional property must conform to the schema](#workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_detail_additionalProperties) |
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_detail_additionalProperties"></a>10.1.1.1.1.3.2.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > detail > additionalProperties`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_detailType"></a>10.1.1.1.1.3.3. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > detailType`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_detailType_items"></a>10.1.1.1.1.3.3.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > detailType > detailType items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_id"></a>10.1.1.1.1.3.4. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > id`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_id_items"></a>10.1.1.1.1.3.4.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > id > id items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_region"></a>10.1.1.1.1.3.5. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > region`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_region_items"></a>10.1.1.1.1.3.5.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > region > region items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_resources"></a>10.1.1.1.1.3.6. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > resources`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_resources_items"></a>10.1.1.1.1.3.6.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > resources > resources items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_source"></a>10.1.1.1.1.3.7. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > source`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_source_items"></a>10.1.1.1.1.3.7.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > source > source items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_time"></a>10.1.1.1.1.3.8. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > time`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_time_items"></a>10.1.1.1.1.3.8.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > time > time items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_version"></a>10.1.1.1.1.3.9. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > version`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_eventPattern_version_items"></a>10.1.1.1.1.3.9.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > eventPattern > version > version items
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_input"></a>10.1.1.1.1.4. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > input`
...
###### <a name="workflowDefinitions_items_eventBridge_eventBridgeRules_additionalProperties_scheduleExpression"></a>10.1.1.1.1.5. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > eventBridgeRules > additionalProperties > scheduleExpression`
...
##### <a name="workflowDefinitions_items_eventBridge_maxEventAgeSeconds"></a>10.1.1.2. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > maxEventAgeSeconds`
...
##### <a name="workflowDefinitions_items_eventBridge_retryAttempts"></a>10.1.1.3. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > retryAttempts`
...
##### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules"></a>10.1.1.4. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules`

|                           |                                                                                                                                       |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                                                              |
| **Required**              | No                                                                                                                                    |
| **Additional properties** | [Each additional property must conform to the schema](#workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties) |
...
###### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties"></a>10.1.1.4.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules > S3EventBridgeRuleProps`
...
| Property                                                                                                     | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------ | ------- | --------------- | ---------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [buckets](#workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_buckets )         | No      | array of string | No         | -          | Array of S3 bucket names that should trigger the EventBridge rule when object events occur.<br /><br />Use cases: S3 event-driven processing; Bucket-specific triggers; Multi-bucket event routing<br /><br />AWS: S3 bucket names for EventBridge S3 object event pattern matching<br /><br />Validation: Required; must be non-empty array of valid S3 bucket names               |
| - [eventBusArn](#workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_eventBusArn ) | No      | string          | No         | -          | ARN of the custom EventBridge event bus where the rule should be created.<br /><br />Use cases: Custom event bus routing; Cross-account event delivery; Dedicated event bus targeting<br /><br />AWS: EventBridge custom event bus ARN for rule placement<br /><br />Validation: Optional; must be a valid EventBridge event bus ARN if provided; defaults to the default event bus |
| - [prefixes](#workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_prefixes )       | No      | array of string | No         | -          | Array of S3 object key prefixes that filter which objects trigger the EventBridge rule.<br /><br />Use cases: Prefix-based event filtering; Selective object processing; Path-scoped triggers<br /><br />AWS: S3 object key prefix filters for EventBridge event pattern matching<br /><br />Validation: Optional; each prefix should be a valid S3 key prefix                      |

###### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_buckets"></a>10.1.1.4.1.1. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules > additionalProperties > buckets`
...
###### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_buckets_items"></a>10.1.1.4.1.1.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules > additionalProperties > buckets > buckets items
...
###### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_eventBusArn"></a>10.1.1.4.1.2. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules > additionalProperties > eventBusArn`
...
###### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_prefixes"></a>10.1.1.4.1.3. Property `root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules > additionalProperties > prefixes`
...
###### <a name="workflowDefinitions_items_eventBridge_s3EventBridgeRules_additionalProperties_prefixes_items"></a>10.1.1.4.1.3.1. root > workflowDefinitions > workflowDefinitions items > eventBridge > s3EventBridgeRules > additionalProperties > prefixes > prefixes items
...
#### <a name="workflowDefinitions_items_rawWorkflowDef"></a>10.1.2. Property `root > workflowDefinitions > workflowDefinitions items > rawWorkflowDef`

|                           |                                                                                                                       |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                                              |
| **Required**              | Yes                                                                                                                   |
| **Additional properties** | [Each additional property must conform to the schema](#workflowDefinitions_items_rawWorkflowDef_additionalProperties) |

**Description:** Raw Glue workflow definition object (as exported from AWS CLI `get-workflow`).
...
##### <a name="workflowDefinitions_items_rawWorkflowDef_additionalProperties"></a>10.1.2.1. Property `root > workflowDefinitions > workflowDefinitions items > rawWorkflowDef > additionalProperties`
