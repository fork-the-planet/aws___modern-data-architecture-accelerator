...
| **Type**                  | `object`                                                                          |
| **Required**              | Yes                                                                               |
| **Additional properties** | [Each additional property must conform to the schema](#jobs_additionalProperties) |

**Description:** Map of job names to Glue job definitions for ETL processing and data transformation.
...
**Description:** Configuration for a Glue job including execution roles, commands, capacity, and monitoring.
...
| Property                                                                   | Pattern | Type             | Deprecated | Definition                                           | Title/Description                                                                                                                                                                                    |
| -------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [additionalFiles](#jobs_additionalProperties_additionalFiles )           | No      | array of string  | No         | -                                                    | Relative paths to additional files for the job.                                                                                                                                                      |
| - [additionalJars](#jobs_additionalProperties_additionalJars )             | No      | array of string  | No         | -                                                    | Relative paths to additional JAR files for the job.                                                                                                                                                  |
| - [additionalScripts](#jobs_additionalProperties_additionalScripts )       | No      | array of string  | No         | -                                                    | Relative paths to additional Python scripts for the job.                                                                                                                                             |
| - [allocatedCapacity](#jobs_additionalProperties_allocatedCapacity )       | No      | number           | No         | -                                                    | Number of capacity units allocated to the job.                                                                                                                                                       |
| + [command](#jobs_additionalProperties_command )                           | No      | object           | No         | In #/definitions/JobCommand                          | Job command configuration defining script and runtime environment.                                                                                                                                   |
| - [connections](#jobs_additionalProperties_connections )                   | No      | array of string  | No         | -                                                    | Connection names for database and external system access.                                                                                                                                            |
| - [continuousLogging](#jobs_additionalProperties_continuousLogging )       | No      | object           | No         | In #/definitions/LoggingConfig                       | Continuous logging configuration for real-time monitoring.                                                                                                                                           |
| - [defaultArguments](#jobs_additionalProperties_defaultArguments )         | No      | object           | No         | -                                                    | Default arguments passed to the job at runtime.                                                                                                                                                      |
| + [description](#jobs_additionalProperties_description )                   | No      | string           | No         | -                                                    | Job description for documentation and management.                                                                                                                                                    |
...
| - [numberOfWorkers](#jobs_additionalProperties_numberOfWorkers )           | No      | number           | No         | -                                                    | Number of workers for parallel processing.                                                                                                                                                           |
| - [template](#jobs_additionalProperties_template )                         | No      | string           | No         | -                                                    | Template name for configuration inheritance.                                                                                                                                                         |
...
**Description:** Relative paths to additional files for the job.
...
**Description:** Relative paths to additional JAR files for the job.
...
**Description:** Relative paths to additional Python scripts for the job.
...
**Description:** Job type: 'glueetl' for Spark ETL or 'pythonshell' for Python scripts.
...
**Description:** Python version for job runtime ('2' or '3').
...
**Description:** Connection names for database and external system access.
...
**Description:** Continuous logging configuration for real-time monitoring.
...
| **Type**                  | `object`                                                                                                                |
| **Required**              | No                                                                                                                      |
| **Additional properties** | [Each additional property must conform to the schema](#jobs_additionalProperties_defaultArguments_additionalProperties) |

**Description:** Default arguments passed to the job at runtime.
...
**Description:** Execution properties including maximum concurrent runs.
...
**Description:** Notification settings for job monitoring and alerting.
...
**Description:** Worker type: 'Standard', 'G.1X', 'G.2X', 'G.4X', 'G.8X', 'G.12X', 'G.16X', 'R.1X', 'R.2X', 'R.4X', or 'R.8X'. G.12X, G.16X, and R types require a compatible Glue version and regional availability.
...
**Description:** DataOps project name for job resource autowiring (databases, roles, security).
...
| **Type**                  | `object`                                                                               |
| **Required**              | No                                                                                     |
| **Additional properties** | [Each additional property must conform to the schema](#templates_additionalProperties) |

**Description:** Reusable job templates that can be inherited by job definitions via the `template` field.
