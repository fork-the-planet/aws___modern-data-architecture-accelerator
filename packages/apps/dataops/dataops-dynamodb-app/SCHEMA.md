...
| - [projectName](#projectName )                                       | No      | string | No         | -                                                   | DataOps project name enabling auto-wiring of shared resources (bucket, KMS key,<br />SNS topic, deployment role, security configuration) via SSM parameters.<br /><br />Use cases: Project resource coordination; Shared infrastructure reuse<br /><br />AWS: DataOps project SSM parameter references<br /><br />Validation: Optional; must match an existing deployed project                                                                                                                                                                                                                                                                                                         |
...
| + [tableDefinitions](#tableDefinitions )                             | No      | object | No         | -                                                   | Map of table names to DynamoDB table definitions.<br /><br />Use cases: NoSQL table provisioning; Schema and capacity configuration<br /><br />AWS: DynamoDB tables<br /><br />Validation: Required; valid TableDefinitionMap                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
## <a name="tableDefinitions"></a>10. Property `root > tableDefinitions`

|                           |                                                                                               |
| ------------------------- | --------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                      |
| **Required**              | Yes                                                                                           |
| **Additional properties** | [Each additional property must conform to the schema](#tableDefinitions_additionalProperties) |

**Description:** Map of table names to DynamoDB table definitions.

Use cases: NoSQL table provisioning; Schema and capacity configuration

AWS: DynamoDB tables

Validation: Required; valid TableDefinitionMap

| Property                                      | Pattern | Type   | Deprecated | Definition                     | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                          |
| --------------------------------------------- | ------- | ------ | ---------- | ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [](#tableDefinitions_additionalProperties ) | No      | object | No         | In #/definitions/DynamodbProps | Configuration for a DynamoDB table including schema, capacity, and TTL settings.<br /><br />Use cases: NoSQL table configuration, database schema definition, capacity planning, TTL management<br /><br />AWS: Amazon DynamoDB table configuration for NoSQL database deployment<br /><br />Validation: partitionKey is required; sortKey, readCapacity, writeCapacity, billingMode, and timeToLiveAttribute are optional |

### <a name="tableDefinitions_additionalProperties"></a>10.1. Property `root > tableDefinitions > DynamodbProps`
...
| **Required**              | No                          |
| **Additional properties** | Not allowed                 |
| **Defined in**            | #/definitions/DynamodbProps |

**Description:** Configuration for a DynamoDB table including schema, capacity, and TTL settings.
...
| Property                                                                             | Pattern | Type             | Deprecated | Definition                                                                   | Title/Description                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------ | ------- | ---------------- | ---------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [billingMode](#tableDefinitions_additionalProperties_billingMode )                 | No      | enum (of string) | No         | -                                                                            | Billing mode controlling the pricing model (PROVISIONED or PAY_PER_REQUEST).<br /><br />Use cases: Cost optimization, billing model selection, workload adaptation<br /><br />AWS: DynamoDB billing mode<br /><br />Validation: Must be PROVISIONED or PAY_PER_REQUEST if provided                                                                                |
| + [partitionKey](#tableDefinitions_additionalProperties_partitionKey )               | No      | object           | No         | In #/definitions/Attribute                                                   | Partition key attribute for the table primary key.<br /><br />Use cases: Primary key definition, data distribution, access pattern design<br /><br />AWS: DynamoDB partition key attribute<br /><br />Validation: Must be a valid Attribute with name and type; required                                                                                          |
| - [readCapacity](#tableDefinitions_additionalProperties_readCapacity )               | No      | number           | No         | -                                                                            | Provisioned read capacity units (reads per second for items up to 4 KB).<br /><br />Use cases: Read performance tuning, cost management, capacity planning<br /><br />AWS: DynamoDB provisioned read capacity units<br /><br />Validation: Must be a positive integer if provided; only applies when billingMode is PROVISIONED                                   |
| - [sortKey](#tableDefinitions_additionalProperties_sortKey )                         | No      | object           | No         | Same as [partitionKey](#tableDefinitions_additionalProperties_partitionKey ) | Optional sort key attribute for composite primary key enabling range queries.<br /><br />Use cases: Composite keys, range queries, hierarchical data organization<br /><br />AWS: DynamoDB sort key attribute<br /><br />Validation: Must be a valid Attribute if provided                                                                                        |
| - [timeToLiveAttribute](#tableDefinitions_additionalProperties_timeToLiveAttribute ) | No      | string           | No         | -                                                                            | TTL attribute name for automatic item expiration based on a timestamp value.<br /><br />Use cases: Data lifecycle management, automatic cleanup, storage cost optimization<br /><br />AWS: DynamoDB TTL attribute for automatic item expiration<br /><br />Validation: Must be a valid attribute name if provided; attribute value must be a Unix epoch timestamp |
| - [writeCapacity](#tableDefinitions_additionalProperties_writeCapacity )             | No      | number           | No         | -                                                                            | Provisioned write capacity units (writes per second for items up to 1 KB).<br /><br />Use cases: Write performance tuning, cost management, capacity planning<br /><br />AWS: DynamoDB provisioned write capacity units<br /><br />Validation: Must be a positive integer if provided; only applies when billingMode is PROVISIONED                               |

#### <a name="tableDefinitions_additionalProperties_billingMode"></a>10.1.1. Property `root > tableDefinitions > additionalProperties > billingMode`
...
**Description:** Billing mode controlling the pricing model (PROVISIONED or PAY_PER_REQUEST).
...
#### <a name="tableDefinitions_additionalProperties_partitionKey"></a>10.1.2. Property `root > tableDefinitions > additionalProperties > partitionKey`
...
| **Required**              | Yes                     |
| **Additional properties** | Not allowed             |
| **Defined in**            | #/definitions/Attribute |

**Description:** Partition key attribute for the table primary key.
...
| Property                                                            | Pattern | Type             | Deprecated | Definition                     | Title/Description              |
| ------------------------------------------------------------------- | ------- | ---------------- | ---------- | ------------------------------ | ------------------------------ |
| + [name](#tableDefinitions_additionalProperties_partitionKey_name ) | No      | string           | No         | -                              | The name of an attribute.      |
| + [type](#tableDefinitions_additionalProperties_partitionKey_type ) | No      | enum (of string) | No         | In #/definitions/AttributeType | The data type of an attribute. |

##### <a name="tableDefinitions_additionalProperties_partitionKey_name"></a>10.1.2.1. Property `root > tableDefinitions > additionalProperties > partitionKey > name`
...
##### <a name="tableDefinitions_additionalProperties_partitionKey_type"></a>10.1.2.2. Property `root > tableDefinitions > additionalProperties > partitionKey > type`

|                |                             |
| -------------- | --------------------------- |
| **Type**       | `enum (of string)`          |
| **Required**   | Yes                         |
| **Defined in** | #/definitions/AttributeType |
...
#### <a name="tableDefinitions_additionalProperties_readCapacity"></a>10.1.3. Property `root > tableDefinitions > additionalProperties > readCapacity`
...
**Description:** Provisioned read capacity units (reads per second for items up to 4 KB).
...
#### <a name="tableDefinitions_additionalProperties_sortKey"></a>10.1.4. Property `root > tableDefinitions > additionalProperties > sortKey`
...
| **Required**              | No                                                                  |
| **Additional properties** | Not allowed                                                         |
| **Same definition as**    | [partitionKey](#tableDefinitions_additionalProperties_partitionKey) |

**Description:** Optional sort key attribute for composite primary key enabling range queries.
...
#### <a name="tableDefinitions_additionalProperties_timeToLiveAttribute"></a>10.1.5. Property `root > tableDefinitions > additionalProperties > timeToLiveAttribute`
...
**Description:** TTL attribute name for automatic item expiration based on a timestamp value.
...
#### <a name="tableDefinitions_additionalProperties_writeCapacity"></a>10.1.6. Property `root > tableDefinitions > additionalProperties > writeCapacity`
...
**Description:** Provisioned write capacity units (writes per second for items up to 1 KB).
