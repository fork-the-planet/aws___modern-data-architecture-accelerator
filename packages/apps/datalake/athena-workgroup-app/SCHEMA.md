...
| - [verbatimPolicyNamePrefix](#verbatimPolicyNamePrefix )             | No      | string | No         | -                                                   | Verbatim policy name prefix bypassing MDAA naming conventions.<br />Useful for cross-account policy portability and SSO permission set integration<br />where policy names must be stable across accounts.<br /><br />Use cases: Cross-account policy portability; SSO permission set integration; Stable policy naming<br /><br />AWS: IAM managed policy naming prefix<br /><br />Validation: Optional; string prefix used instead of MDAA naming for policy names                                                                                                                                                                                                                    |
| - [workgroupConfiguration](#workgroupConfiguration )                 | No      | object | No         | In #/definitions/WorkgroupConfigurationConfig       | Workgroup configuration settings for query cost controls and performance limits.<br /><br />Use cases: Query cost control; Bytes-scanned limits; Resource usage management<br /><br />AWS: Athena workgroup configuration settings<br /><br />Validation: Optional; valid WorkgroupConfigurationConfig                                                                                                                                                                                                                                                                                                                                                                                  |

## <a name="athenaUserRoles"></a>1. Property `root > athenaUserRoles`
...
**Description:** User roles granted query execution access to the workgroup and read/write access to the results bucket.
...
| ------------------------------------- | ----------- |
| [MdaaRoleRef](#athenaUserRoles_items) | -           |

### <a name="athenaUserRoles_items"></a>1.1. root > athenaUserRoles > MdaaRoleRef
...
#### <a name="athenaUserRoles_items_id"></a>1.1.2. Property `root > athenaUserRoles > athenaUserRoles items > id`
...
#### <a name="athenaUserRoles_items_immutable"></a>1.1.3. Property `root > athenaUserRoles > athenaUserRoles items > immutable`
...
#### <a name="athenaUserRoles_items_name"></a>1.1.4. Property `root > athenaUserRoles > athenaUserRoles items > name`
...
#### <a name="athenaUserRoles_items_refId"></a>1.1.5. Property `root > athenaUserRoles > athenaUserRoles items > refId`
...
#### <a name="athenaUserRoles_items_sso"></a>1.1.6. Property `root > athenaUserRoles > athenaUserRoles items > sso`
...
**Description:** Admin roles granted full access to Athena workgroup resources including KMS key, results bucket,
...
**Description:** Verbatim policy name prefix bypassing MDAA naming conventions.
...
| **Required**              | No                                         |
| **Additional properties** | Not allowed                                |
| **Defined in**            | #/definitions/WorkgroupConfigurationConfig |

**Description:** Workgroup configuration settings for query cost controls and performance limits.
...
**Description:** Upper limit in bytes for data scanned per query. Queries exceeding this limit are cancelled.
