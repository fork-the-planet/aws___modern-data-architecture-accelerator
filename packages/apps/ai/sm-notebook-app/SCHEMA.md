...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [assetDeploymentConfig](#assetDeploymentConfig )                   | No      | object | No         | In #/definitions/NotebookAssetDeploymentConfig      | Asset deployment configuration for automated notebook code and resource provisioning.<br /><br />Use cases: Automated asset deployment, consistent development environments, code provisioning<br /><br />AWS: SageMaker notebook instance asset deployment<br /><br />Validation: Optional; NotebookAssetDeploymentConfig                                                                                                                                                                                                                                                                                                                                                              |
| - [kmsKeyArn](#kmsKeyArn )                                           | No      | string | No         | -                                                   | Existing KMS key ARN for notebook instance encryption.<br />If omitted, a customer-managed key is created automatically.<br /><br />Use cases: Customer-controlled encryption, data protection compliance, key reuse<br /><br />AWS: KMS key for SageMaker notebook encryption<br /><br />Validation: Optional; String; must be valid KMS key ARN                                                                                                                                                                                                                                                                                                                                       |
| - [lifecycleConfigs](#lifecycleConfigs )                             | No      | object | No         | In #/definitions/NamedLifecycleConfigProps          | Map of lifecycle configuration names to lifecycle configs with startup/shutdown scripts.<br /><br />Use cases: Automated environment setup, consistent notebook configuration, resource management<br /><br />AWS: SageMaker lifecycle configurations<br /><br />Validation: Optional; NamedLifecycleConfigProps (map of name to config)                                                                                                                                                                                                                                                                                                                                                |
...
| - [notebooks](#notebooks )                                           | No      | object | No         | In #/definitions/NotebookWithIdProps                | Map of notebook names to notebook instance configurations with compute, networking, and access controls.<br /><br />Use cases: Data science development, ML notebook provisioning, development environment setup<br /><br />AWS: SageMaker notebook instances<br /><br />Validation: Optional; NotebookWithIdProps (map of notebook name to config)                                                                                                                                                                                                                                                                                                                                     |
...
**Description:** Asset deployment configuration for automated notebook code and resource provisioning.
...
| Property                                                                   | Pattern | Type   | Deprecated | Definition | Title/Description                              |
| -------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ---------------------------------------------- |
| + [assetBucketName](#assetDeploymentConfig_assetBucketName )               | No      | string | No         | -          | S3 bucket name for notebook asset storage      |
| + [assetDeploymentRoleArn](#assetDeploymentConfig_assetDeploymentRoleArn ) | No      | string | No         | -          | IAM role ARN for asset deployment Lambda       |
| - [assetPrefix](#assetDeploymentConfig_assetPrefix )                       | No      | string | No         | -          | S3 prefix for asset organization               |
| - [memoryLimitMB](#assetDeploymentConfig_memoryLimitMB )                   | No      | number | No         | -          | Lambda memory limit in MB for asset deployment |
...
**Description:** S3 bucket name for notebook asset storage
...
**Description:** IAM role ARN for asset deployment Lambda
...
**Description:** S3 prefix for asset organization
...
**Description:** Lambda memory limit in MB for asset deployment
...
**Description:** Existing KMS key ARN for notebook instance encryption.
...
| **Type**                  | `object`                                                                                      |
| **Required**              | No                                                                                            |
| **Additional properties** | [Each additional property must conform to the schema](#lifecycleConfigs_additionalProperties) |
| **Defined in**            | #/definitions/NamedLifecycleConfigProps                                                       |

**Description:** Map of lifecycle configuration names to lifecycle configs with startup/shutdown scripts.
...
| Property                                                       | Pattern | Type   | Deprecated | Definition                                                           | Title/Description                               |
| -------------------------------------------------------------- | ------- | ------ | ---------- | -------------------------------------------------------------------- | ----------------------------------------------- |
| - [onCreate](#lifecycleConfigs_additionalProperties_onCreate ) | No      | object | No         | In #/definitions/LifecycleScriptProps                                | Lifecycle script for notebook instance creation |
| - [onStart](#lifecycleConfigs_additionalProperties_onStart )   | No      | object | No         | Same as [onCreate](#lifecycleConfigs_additionalProperties_onCreate ) | Lifecycle script for notebook instance startup  |
...
**Description:** Lifecycle script for notebook instance creation

| Property                                                            | Pattern | Type            | Deprecated | Definition                       | Title/Description                                |
| ------------------------------------------------------------------- | ------- | --------------- | ---------- | -------------------------------- | ------------------------------------------------ |
| - [assets](#lifecycleConfigs_additionalProperties_onCreate_assets ) | No      | object          | No         | In #/definitions/NamedAssetProps | Named assets to deploy for this lifecycle script |
...
| **Type**                  | `object`                                                                                                                           |
| **Required**              | No                                                                                                                                 |
| **Additional properties** | [Each additional property must conform to the schema](#lifecycleConfigs_additionalProperties_onCreate_assets_additionalProperties) |
| **Defined in**            | #/definitions/NamedAssetProps                                                                                                      |

**Description:** Named assets to deploy for this lifecycle script
...
| Property                                                                                                | Pattern | Type            | Deprecated | Definition | Title/Description                             |
| ------------------------------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | --------------------------------------------- |
| - [exclude](#lifecycleConfigs_additionalProperties_onCreate_assets_additionalProperties_exclude )       | No      | array of string | No         | -          | Glob patterns to exclude from asset packaging |
| + [sourcePath](#lifecycleConfigs_additionalProperties_onCreate_assets_additionalProperties_sourcePath ) | No      | string          | No         | -          | Local file or directory path to deploy        |
...
**Description:** Glob patterns to exclude from asset packaging
...
###### <a name="lifecycleConfigs_additionalProperties_onCreate_assets_additionalProperties_exclude_items"></a>3.1.1.1.1.1.1. root > lifecycleConfigs > additionalProperties > onCreate > assets > additionalProperties > exclude > exclude items
...
**Description:** Local file or directory path to deploy
...
###### <a name="lifecycleConfigs_additionalProperties_onCreate_cmds_items"></a>3.1.1.2.1. root > lifecycleConfigs > additionalProperties > onCreate > cmds > cmds items
...
**Description:** Lifecycle script for notebook instance startup
...
| **Type**                  | `object`                                                                               |
| **Required**              | No                                                                                     |
| **Additional properties** | [Each additional property must conform to the schema](#notebooks_additionalProperties) |
| **Defined in**            | #/definitions/NotebookWithIdProps                                                      |

**Description:** Map of notebook names to notebook instance configurations with compute, networking, and access controls.
...
| + [instanceType](#notebooks_additionalProperties_instanceType )                                                 | No      | string          | No         | -                                                                                   | EC2 instance type for the notebook |
| - [lifecycleConfigName](#notebooks_additionalProperties_lifecycleConfigName )                                   | No      | string          | No         | -                                                                                   | -                                  |
| - [notebookName](#notebooks_additionalProperties_notebookName )                                                 | No      | string          | No         | -                                                                                   | Custom notebook instance name      |
| + [notebookRole](#notebooks_additionalProperties_notebookRole )                                                 | No      | object          | No         | In #/definitions/MdaaRoleRef                                                        | IAM role for notebook instance     |
...
| + [subnetId](#notebooks_additionalProperties_subnetId )                                                         | No      | string          | No         | -                                                                                   | Subnet ID for notebook placement   |
| - [volumeSizeInGb](#notebooks_additionalProperties_volumeSizeInGb )                                             | No      | number          | No         | -                                                                                   | -                                  |
| + [vpcId](#notebooks_additionalProperties_vpcId )                                                               | No      | string          | No         | -                                                                                   | VPC ID for notebook deployment     |
...
##### <a name="notebooks_additionalProperties_acceleratorTypes_items"></a>5.1.1.1. root > notebooks > additionalProperties > acceleratorTypes > acceleratorTypes items
...
##### <a name="notebooks_additionalProperties_additionalCodeRepositories_items"></a>5.1.2.1. root > notebooks > additionalProperties > additionalCodeRepositories > additionalCodeRepositories items
...
**Description:** Custom notebook instance name
...
| Property                                                                        | Pattern | Type  | Deprecated | Definition | Title/Description                                                                                               |
| ------------------------------------------------------------------------------- | ------- | ----- | ---------- | ---------- | --------------------------------------------------------------------------------------------------------------- |
| - [ipv4](#notebooks_additionalProperties_securityGroupEgress_ipv4 )             | No      | array | No         | -          | IPv4 CIDR block rules for security group traffic control defining IP address-based access restrictions          |
| - [prefixList](#notebooks_additionalProperties_securityGroupEgress_prefixList ) | No      | array | No         | -          | Prefix list rules for security group traffic control defining managed prefix list-based access restrictions     |
| - [sg](#notebooks_additionalProperties_securityGroupEgress_sg )                 | No      | array | No         | -          | Security group rules for cross-security group traffic control defining security group-based access restrictions |
...
###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items"></a>5.1.11.1.1. root > notebooks > additionalProperties > securityGroupEgress > ipv4 > MdaaCidrPeer
...
| Property                                                                                       | Pattern | Type   | Deprecated | Definition | Title/Description                                                                             |
| ---------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------------------------------------------------------------- |
| + [cidr](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_cidr )                 | No      | string | No         | -          | CIDR block specification for network access control in security group rules enabling IP       |
...
| - [toPort](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_toPort )             | No      | number | No         | -          | The ending port number for the security group rule defining the upper bound of the port range |
...
| Each item of this array must be                                                                         | Description                               |
| ------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| [NagPackSuppression](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items) | Interface for creating a rule suppression |

###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items"></a>5.1.11.1.1.5.1. root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > NagPackSuppression
...
| Property                                                                                                    | Pattern | Type   | Deprecated | Definition | Title/Description                                     |
| ----------------------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------------------------------------------- |
| - [appliesTo](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo ) | No      | array  | No         | -          | Rule specific granular suppressions                   |
| + [id](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_id )               | No      | string | No         | -          | The id of the rule to ignore                          |
| + [reason](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_reason )       | No      | string | No         | -          | The reason to ignore the rule (minimum 10 characters) |

###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo"></a>5.1.11.1.1.5.1.1. Property `root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > appliesTo`
...
| Each item of this array must be                                                                                                  | Description            |
| -------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| [NagPackSuppressionAppliesTo](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items) | A granular suppression |

###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items"></a>5.1.11.1.1.5.1.1.1. root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > appliesTo > NagPackSuppressionAppliesTo
...
| Any of(Option)                                                                                                               |
| ---------------------------------------------------------------------------------------------------------------------------- |
| [RegexAppliesTo](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items_anyOf_i0) |
| [item 1](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items_anyOf_i1)         |

###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items_anyOf_i0"></a>5.1.11.1.1.5.1.1.1.1. Property `root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > appliesTo > appliesTo items > anyOf > RegexAppliesTo`
...
| Property                                                                                                                     | Pattern | Type   | Deprecated | Definition | Title/Description        |
| ---------------------------------------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ------------------------ |
| + [regex](#notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items_anyOf_i0_regex ) | No      | string | No         | -          | An ECMA-262 regex string |

###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items_anyOf_i0_regex"></a>5.1.11.1.1.5.1.1.1.1.1. Property `root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > appliesTo > appliesTo items > anyOf > item 0 > regex`
...
###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_appliesTo_items_anyOf_i1"></a>5.1.11.1.1.5.1.1.1.2. Property `root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > appliesTo > appliesTo items > anyOf > item 1`
...
###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_id"></a>5.1.11.1.1.5.1.2. Property `root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > id`
...
###### <a name="notebooks_additionalProperties_securityGroupEgress_ipv4_items_suppressions_items_reason"></a>5.1.11.1.1.5.1.3. Property `root > notebooks > additionalProperties > securityGroupEgress > ipv4 > ipv4 items > suppressions > suppressions items > reason`
...
###### <a name="notebooks_additionalProperties_securityGroupEgress_prefixList_items"></a>5.1.11.2.1. root > notebooks > additionalProperties > securityGroupEgress > prefixList > MdaaPrefixListPeer
...
| + [prefixList](#notebooks_additionalProperties_securityGroupEgress_prefixList_items_prefixList )     | No      | string | No         | -          | Prefix list identifier for managed IP range access control in security group rules enabling   |
...
| - [toPort](#notebooks_additionalProperties_securityGroupEgress_prefixList_items_toPort )             | No      | number | No         | -          | The ending port number for the security group rule defining the upper bound of the port range |
...
| Each item of this array must be                                                                               | Description                               |
| ------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| [NagPackSuppression](#notebooks_additionalProperties_securityGroupEgress_prefixList_items_suppressions_items) | Interface for creating a rule suppression |

###### <a name="notebooks_additionalProperties_securityGroupEgress_prefixList_items_suppressions_items"></a>5.1.11.2.1.5.1. root > notebooks > additionalProperties > securityGroupEgress > prefixList > prefixList items > suppressions > NagPackSuppression
...
###### <a name="notebooks_additionalProperties_securityGroupEgress_sg_items"></a>5.1.11.3.1. root > notebooks > additionalProperties > securityGroupEgress > sg > MdaaSecurityGroupPeer
...
| + [sgId](#notebooks_additionalProperties_securityGroupEgress_sg_items_sgId )                 | No      | string | No         | -          | Security group identifier for security group-based access control in network rules enabling   |
| - [suppressions](#notebooks_additionalProperties_securityGroupEgress_sg_items_suppressions ) | No      | array  | No         | -          | -                                                                                             |
| - [toPort](#notebooks_additionalProperties_securityGroupEgress_sg_items_toPort )             | No      | number | No         | -          | The ending port number for the security group rule defining the upper bound of the port range |
...
| Each item of this array must be                                                                       | Description                               |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| [NagPackSuppression](#notebooks_additionalProperties_securityGroupEgress_sg_items_suppressions_items) | Interface for creating a rule suppression |

###### <a name="notebooks_additionalProperties_securityGroupEgress_sg_items_suppressions_items"></a>5.1.11.3.1.5.1. root > notebooks > additionalProperties > securityGroupEgress > sg > sg items > suppressions > NagPackSuppression
...
**Description:** Subnet ID for notebook placement
...
**Description:** VPC ID for notebook deployment
...
| + [provisioningRole](#sagemakerBlueprint_provisioningRole )           | No      | object          | No         | Same as [notebookRole](#notebooks_additionalProperties_notebookRole ) | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| + [provisioningRole](#sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole )           | No      | object          | No         | Same as [notebookRole](#notebooks_additionalProperties_notebookRole ) | -                 |
...
| **Required**              | Yes                                                          |
| **Additional properties** | Not allowed                                                  |
| **Same definition as**    | [notebookRole](#notebooks_additionalProperties_notebookRole) |
