...
| -------------------------------------------------------------------- | ------- | --------------- | ---------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [baselineDatasetFormat](#baselineDatasetFormat )                   | No      | string          | No         | -                                                   | Dataset format for baselining (default: '{"csv": {"header": true}}')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| - [baselineOutputDataS3Uri](#baselineOutputDataS3Uri )               | No      | string          | No         | -                                                   | S3 URI for baseline output (enables automated baselining)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| - [baselineSchedule](#baselineSchedule )                             | No      | string          | No         | -                                                   | Schedule expression for periodic re-baselining                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| - [baselineTrainingDataS3Uri](#baselineTrainingDataS3Uri )           | No      | string          | No         | -                                                   | S3 URI for baseline training data (enables automated baselining)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| + [endpointName](#endpointName )                                     | No      | string          | No         | -                                                   | Name of the SageMaker endpoint to monitor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| - [kmsKeyArn](#kmsKeyArn )                                           | No      | string          | No         | -                                                   | KMS key ARN for encryption (if omitted, a new key is created)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| - [modelBucketArn](#modelBucketArn )                                 | No      | string          | No         | -                                                   | S3 bucket ARN for model artifacts                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| + [monitors](#monitors )                                             | No      | object          | No         | In #/definitions/MonitorsMap                        | Map of monitor type to config                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| - [networkIsolation](#networkIsolation )                             | No      | boolean         | No         | -                                                   | Enable network isolation for monitoring jobs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| - [securityGroupIds](#securityGroupIds )                             | No      | array of string | No         | -                                                   | Security group IDs for monitoring jobs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| - [subnetIds](#subnetIds )                                           | No      | array of string | No         | -                                                   | Subnet IDs for monitoring jobs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| - [vpcId](#vpcId )                                                   | No      | string          | No         | -                                                   | VPC ID for monitoring jobs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |

## <a name="baselineDatasetFormat"></a>1. Property `root > baselineDatasetFormat`
...
**Description:** Dataset format for baselining (default: '{"csv": {"header": true}}')

## <a name="baselineOutputDataS3Uri"></a>2. Property `root > baselineOutputDataS3Uri`
...
**Description:** S3 URI for baseline output (enables automated baselining)

## <a name="baselineSchedule"></a>3. Property `root > baselineSchedule`
...
**Description:** Schedule expression for periodic re-baselining

## <a name="baselineTrainingDataS3Uri"></a>4. Property `root > baselineTrainingDataS3Uri`
...
**Description:** S3 URI for baseline training data (enables automated baselining)

## <a name="endpointName"></a>5. Property `root > endpointName`
...
## <a name="kmsKeyArn"></a>6. Property `root > kmsKeyArn`
...
**Description:** KMS key ARN for encryption (if omitted, a new key is created)

## <a name="modelBucketArn"></a>7. Property `root > modelBucketArn`
...
## <a name="monitors"></a>8. Property `root > monitors`
...
| **Required**              | Yes                       |
| **Additional properties** | Not allowed               |
| **Defined in**            | #/definitions/MonitorsMap |

**Description:** Map of monitor type to config

| Property                                                | Pattern | Type   | Deprecated | Definition                                    | Title/Description                      |
| ------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------- | -------------------------------------- |
| - [dataQuality](#monitors_dataQuality )                 | No      | object | No         | In #/definitions/MonitorConfig                | Data quality monitoring config         |
| - [modelBias](#monitors_modelBias )                     | No      | object | No         | Same as [dataQuality](#monitors_dataQuality ) | Model bias monitoring config           |
| - [modelExplainability](#monitors_modelExplainability ) | No      | object | No         | Same as [dataQuality](#monitors_dataQuality ) | Model explainability monitoring config |
| - [modelQuality](#monitors_modelQuality )               | No      | object | No         | Same as [dataQuality](#monitors_dataQuality ) | Model quality monitoring config        |

### <a name="monitors_dataQuality"></a>8.1. Property `root > monitors > dataQuality`
...
| **Required**              | No                          |
| **Additional properties** | Not allowed                 |
| **Defined in**            | #/definitions/MonitorConfig |

**Description:** Data quality monitoring config

| Property                                                                  | Pattern | Type             | Deprecated | Definition | Title/Description                                                                                     |
| ------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------------------------------------------------------------------------------------------- |
| - [analysisConfigUri](#monitors_dataQuality_analysisConfigUri )           | No      | string           | No         | -          | S3 URI for analysis_config.json (bias/explainability). Defaults to <outputS3Uri>/analysis_config.json |
| - [baselineConstraintsUri](#monitors_dataQuality_baselineConstraintsUri ) | No      | string           | No         | -          | S3 URI for baseline constraints                                                                       |
| - [baselineDatasetUri](#monitors_dataQuality_baselineDatasetUri )         | No      | string           | No         | -          | S3 URI for baseline dataset                                                                           |
| - [baselineStatisticsUri](#monitors_dataQuality_baselineStatisticsUri )   | No      | string           | No         | -          | S3 URI for baseline statistics                                                                        |
| + [enabled](#monitors_dataQuality_enabled )                               | No      | boolean          | No         | -          | Enable this monitor type                                                                              |
| - [featuresAttribute](#monitors_dataQuality_featuresAttribute )           | No      | string           | No         | -          | Features attribute name (for bias/explainability)                                                     |
| - [groundTruthS3Uri](#monitors_dataQuality_groundTruthS3Uri )             | No      | string           | No         | -          | S3 URI for ground truth data (model-quality, model-bias)                                              |
| - [imageUri](#monitors_dataQuality_imageUri )                             | No      | string           | No         | -          | SageMaker Clarify image URI (for bias/explainability)                                                 |
| - [inferenceAttribute](#monitors_dataQuality_inferenceAttribute )         | No      | string           | No         | -          | Inference attribute name                                                                              |
| - [instanceCount](#monitors_dataQuality_instanceCount )                   | No      | number           | No         | -          | Instance count for monitoring job                                                                     |
| - [instanceType](#monitors_dataQuality_instanceType )                     | No      | string           | No         | -          | Instance type for monitoring job                                                                      |
| - [maxRuntimeInSeconds](#monitors_dataQuality_maxRuntimeInSeconds )       | No      | number           | No         | -          | Max runtime in seconds                                                                                |
| - [probabilityAttribute](#monitors_dataQuality_probabilityAttribute )     | No      | string           | No         | -          | Probability attribute name                                                                            |
| - [probabilityThreshold](#monitors_dataQuality_probabilityThreshold )     | No      | number           | No         | -          | Probability threshold                                                                                 |
| - [problemType](#monitors_dataQuality_problemType )                       | No      | enum (of string) | No         | -          | Problem type (for model-quality: Regression, BinaryClassification, MulticlassClassification)          |
| - [schedule](#monitors_dataQuality_schedule )                             | No      | string           | No         | -          | Cron schedule expression                                                                              |
| - [volumeSizeInGb](#monitors_dataQuality_volumeSizeInGb )                 | No      | number           | No         | -          | Volume size in GB                                                                                     |

#### <a name="monitors_dataQuality_analysisConfigUri"></a>8.1.1. Property `root > monitors > dataQuality > analysisConfigUri`
...
**Description:** S3 URI for analysis_config.json (bias/explainability). Defaults to <outputS3Uri>/analysis_config.json

#### <a name="monitors_dataQuality_baselineConstraintsUri"></a>8.1.2. Property `root > monitors > dataQuality > baselineConstraintsUri`
...
#### <a name="monitors_dataQuality_baselineDatasetUri"></a>8.1.3. Property `root > monitors > dataQuality > baselineDatasetUri`
...
**Description:** S3 URI for baseline dataset

#### <a name="monitors_dataQuality_baselineStatisticsUri"></a>8.1.4. Property `root > monitors > dataQuality > baselineStatisticsUri`
...
#### <a name="monitors_dataQuality_enabled"></a>8.1.5. Property `root > monitors > dataQuality > enabled`
...
**Description:** Enable this monitor type

#### <a name="monitors_dataQuality_featuresAttribute"></a>8.1.6. Property `root > monitors > dataQuality > featuresAttribute`
...
**Description:** Features attribute name (for bias/explainability)

#### <a name="monitors_dataQuality_groundTruthS3Uri"></a>8.1.7. Property `root > monitors > dataQuality > groundTruthS3Uri`
...
**Description:** S3 URI for ground truth data (model-quality, model-bias)

#### <a name="monitors_dataQuality_imageUri"></a>8.1.8. Property `root > monitors > dataQuality > imageUri`
...
**Description:** SageMaker Clarify image URI (for bias/explainability)

#### <a name="monitors_dataQuality_inferenceAttribute"></a>8.1.9. Property `root > monitors > dataQuality > inferenceAttribute`
...
**Description:** Inference attribute name

#### <a name="monitors_dataQuality_instanceCount"></a>8.1.10. Property `root > monitors > dataQuality > instanceCount`
...
**Description:** Instance count for monitoring job

#### <a name="monitors_dataQuality_instanceType"></a>8.1.11. Property `root > monitors > dataQuality > instanceType`
...
**Description:** Instance type for monitoring job

#### <a name="monitors_dataQuality_maxRuntimeInSeconds"></a>8.1.12. Property `root > monitors > dataQuality > maxRuntimeInSeconds`
...
#### <a name="monitors_dataQuality_probabilityAttribute"></a>8.1.13. Property `root > monitors > dataQuality > probabilityAttribute`
...
**Description:** Probability attribute name

#### <a name="monitors_dataQuality_probabilityThreshold"></a>8.1.14. Property `root > monitors > dataQuality > probabilityThreshold`
...
#### <a name="monitors_dataQuality_problemType"></a>8.1.15. Property `root > monitors > dataQuality > problemType`
...
**Description:** Problem type (for model-quality: Regression, BinaryClassification, MulticlassClassification)
...
#### <a name="monitors_dataQuality_schedule"></a>8.1.16. Property `root > monitors > dataQuality > schedule`
...
#### <a name="monitors_dataQuality_volumeSizeInGb"></a>8.1.17. Property `root > monitors > dataQuality > volumeSizeInGb`
...
### <a name="monitors_modelBias"></a>8.2. Property `root > monitors > modelBias`
...
| **Required**              | No                                   |
| **Additional properties** | Not allowed                          |
| **Same definition as**    | [dataQuality](#monitors_dataQuality) |

**Description:** Model bias monitoring config

### <a name="monitors_modelExplainability"></a>8.3. Property `root > monitors > modelExplainability`
...
**Description:** Model explainability monitoring config

### <a name="monitors_modelQuality"></a>8.4. Property `root > monitors > modelQuality`
...
**Description:** Model quality monitoring config
...
## <a name="networkIsolation"></a>10. Property `root > networkIsolation`
...
**Description:** Enable network isolation for monitoring jobs
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_arn"></a>11.1.1.5.1. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > arn`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_id"></a>11.1.1.5.2. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > id`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_immutable"></a>11.1.1.5.3. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > immutable`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_name"></a>11.1.1.5.4. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > name`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_refId"></a>11.1.1.5.5. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > refId`
...
###### <a name="sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole_sso"></a>11.1.1.5.6. Property `root > sagemakerBlueprint > additionalAccounts > additionalProperties > provisioningRole > sso`
...
## <a name="securityGroupIds"></a>12. Property `root > securityGroupIds`
...
**Description:** Security group IDs for monitoring jobs
...
| Each item of this array must be                   | Description |
| ------------------------------------------------- | ----------- |
| [securityGroupIds items](#securityGroupIds_items) | -           |

### <a name="securityGroupIds_items"></a>12.1. root > securityGroupIds > securityGroupIds items
...
## <a name="subnetIds"></a>14. Property `root > subnetIds`
...
**Description:** Subnet IDs for monitoring jobs
...
### <a name="subnetIds_items"></a>14.1. root > subnetIds > subnetIds items
...
## <a name="vpcId"></a>15. Property `root > vpcId`
...
**Description:** VPC ID for monitoring jobs
