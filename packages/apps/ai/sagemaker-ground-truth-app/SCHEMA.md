...
**Description:** Top-level config contents

| Property                                                             | Pattern | Type   | Deprecated | Definition                                          | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [jobs](#jobs )                                                     | No      | array  | No         | -                                                   | List of labeling job configurations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
## <a name="jobs"></a>1. Property `root > jobs`
...
**Description:** List of labeling job configurations.
...
| ----------------------------------- | ---------------------------------------------------- |
| [GroundTruthJobConfig](#jobs_items) | Configuration for a single Ground Truth labeling job |

### <a name="jobs_items"></a>1.1. root > jobs > GroundTruthJobConfig
...
| **Required**              | No                                 |
| **Additional properties** | Not allowed                        |
| **Defined in**            | #/definitions/GroundTruthJobConfig |

**Description:** Configuration for a single Ground Truth labeling job

| Property                                                                    | Pattern | Type             | Deprecated | Definition                                     | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| - [additionalFeatureDefinitions](#jobs_items_additionalFeatureDefinitions ) | No      | array            | No         | -                                              | Additional feature definitions for the Feature Group                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| - [groundTruthRole](#jobs_items_groundTruthRole )                           | No      | object           | No         | In #/definitions/MdaaRoleRef                   | Optional externally-created IAM role for SageMaker Ground Truth labeling jobs.<br />When provided, the construct imports this role and attaches Ground Truth-specific<br />permissions (S3, KMS, SageMaker) to it via a managed policy.<br /><br />Use this when the role needs access to S3 buckets from other MDAA modules (e.g., datalake).<br />The external module grants bucket access to this role, then Ground Truth attaches its own permissions.<br /><br />If omitted, the construct creates a new role with sagemaker.amazonaws.com trust. |
| + [jobName](#jobs_items_jobName )                                           | No      | string           | No         | -                                              | Unique name prefix for this labeling job (used in resource naming)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| + [labelingTaskConfig](#jobs_items_labelingTaskConfig )                     | No      | object           | No         | In #/definitions/GroundTruthLabelingTaskConfig | Labeling task configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| - [sqsConfig](#jobs_items_sqsConfig )                                       | No      | object           | No         | In #/definitions/GroundTruthSqsConfig          | SQS configuration (optional)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| + [taskType](#jobs_items_taskType )                                         | No      | enum (of string) | No         | In #/definitions/GroundTruthTaskType           | The labeling task type                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| - [verification](#jobs_items_verification )                                 | No      | object           | No         | In #/definitions/GroundTruthVerificationConfig | Optional verification step configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| - [workflowSchedule](#jobs_items_workflowSchedule )                         | No      | string           | No         | -                                              | Cron schedule for the workflow (default: "cron(0 12 * * ? *)")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

#### <a name="jobs_items_additionalFeatureDefinitions"></a>1.1.1. Property `root > jobs > jobs items > additionalFeatureDefinitions`
...
**Description:** Additional feature definitions for the Feature Group
...
| Each item of this array must be                                           | Description                                    |
| ------------------------------------------------------------------------- | ---------------------------------------------- |
| [FeatureDefinitionConfig](#jobs_items_additionalFeatureDefinitions_items) | Feature definition for SageMaker Feature Group |

##### <a name="jobs_items_additionalFeatureDefinitions_items"></a>1.1.1.1. root > jobs > jobs items > additionalFeatureDefinitions > FeatureDefinitionConfig
...
| **Required**              | No                                    |
| **Additional properties** | Not allowed                           |
| **Defined in**            | #/definitions/FeatureDefinitionConfig |

**Description:** Feature definition for SageMaker Feature Group

| Property                                                                     | Pattern | Type             | Deprecated | Definition | Title/Description                             |
| ---------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | --------------------------------------------- |
| + [featureName](#jobs_items_additionalFeatureDefinitions_items_featureName ) | No      | string           | No         | -          | Feature name                                  |
| + [featureType](#jobs_items_additionalFeatureDefinitions_items_featureType ) | No      | enum (of string) | No         | -          | Feature type: String, Integral, or Fractional |

###### <a name="jobs_items_additionalFeatureDefinitions_items_featureName"></a>1.1.1.1.1. Property `root > jobs > jobs items > additionalFeatureDefinitions > additionalFeatureDefinitions items > featureName`
...
###### <a name="jobs_items_additionalFeatureDefinitions_items_featureType"></a>1.1.1.1.2. Property `root > jobs > jobs items > additionalFeatureDefinitions > additionalFeatureDefinitions items > featureType`
...
**Description:** Feature type: String, Integral, or Fractional
...
#### <a name="jobs_items_groundTruthRole"></a>1.1.2. Property `root > jobs > jobs items > groundTruthRole`
...
**Description:** Optional externally-created IAM role for SageMaker Ground Truth labeling jobs.
...
##### <a name="jobs_items_groundTruthRole_id"></a>1.1.2.2. Property `root > jobs > jobs items > groundTruthRole > id`
...
##### <a name="jobs_items_groundTruthRole_immutable"></a>1.1.2.3. Property `root > jobs > jobs items > groundTruthRole > immutable`
...
##### <a name="jobs_items_groundTruthRole_name"></a>1.1.2.4. Property `root > jobs > jobs items > groundTruthRole > name`
...
##### <a name="jobs_items_groundTruthRole_refId"></a>1.1.2.5. Property `root > jobs > jobs items > groundTruthRole > refId`
...
##### <a name="jobs_items_groundTruthRole_sso"></a>1.1.2.6. Property `root > jobs > jobs items > groundTruthRole > sso`
...
#### <a name="jobs_items_jobName"></a>1.1.3. Property `root > jobs > jobs items > jobName`
...
**Description:** Unique name prefix for this labeling job (used in resource naming)

#### <a name="jobs_items_labelingTaskConfig"></a>1.1.4. Property `root > jobs > jobs items > labelingTaskConfig`
...
| **Required**              | Yes                                         |
| **Additional properties** | Not allowed                                 |
| **Defined in**            | #/definitions/GroundTruthLabelingTaskConfig |

**Description:** Labeling task configuration

| Property                                                                                                 | Pattern | Type            | Deprecated | Definition | Title/Description                                                 |
| -------------------------------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ----------------------------------------------------------------- |
| + [categoriesS3Uri](#jobs_items_labelingTaskConfig_categoriesS3Uri )                                     | No      | string          | No         | -          | S3 URI for the categories file                                    |
| - [numberOfHumanWorkersPerDataObject](#jobs_items_labelingTaskConfig_numberOfHumanWorkersPerDataObject ) | No      | number          | No         | -          | Workers per data object (default: 1)                              |
| - [taskAvailabilityLifetimeInSeconds](#jobs_items_labelingTaskConfig_taskAvailabilityLifetimeInSeconds ) | No      | number          | No         | -          | Task availability lifetime in seconds (default: 21600)            |
| + [taskDescription](#jobs_items_labelingTaskConfig_taskDescription )                                     | No      | string          | No         | -          | Description of the labeling task                                  |
| + [taskKeywords](#jobs_items_labelingTaskConfig_taskKeywords )                                           | No      | array of string | No         | -          | Keywords for the labeling task                                    |
| - [taskTimeLimitInSeconds](#jobs_items_labelingTaskConfig_taskTimeLimitInSeconds )                       | No      | number          | No         | -          | Time limit per task in seconds (default: 300)                     |
| + [taskTitle](#jobs_items_labelingTaskConfig_taskTitle )                                                 | No      | string          | No         | -          | Title of the labeling task shown to workers                       |
| - [templateS3Uri](#jobs_items_labelingTaskConfig_templateS3Uri )                                         | No      | string          | No         | -          | S3 URI for the labeling UI template (optional for built-in types) |
| + [workteamArn](#jobs_items_labelingTaskConfig_workteamArn )                                             | No      | string          | No         | -          | ARN of the workteam                                               |

##### <a name="jobs_items_labelingTaskConfig_categoriesS3Uri"></a>1.1.4.1. Property `root > jobs > jobs items > labelingTaskConfig > categoriesS3Uri`
...
**Description:** S3 URI for the categories file

##### <a name="jobs_items_labelingTaskConfig_numberOfHumanWorkersPerDataObject"></a>1.1.4.2. Property `root > jobs > jobs items > labelingTaskConfig > numberOfHumanWorkersPerDataObject`
...
**Description:** Workers per data object (default: 1)

##### <a name="jobs_items_labelingTaskConfig_taskAvailabilityLifetimeInSeconds"></a>1.1.4.3. Property `root > jobs > jobs items > labelingTaskConfig > taskAvailabilityLifetimeInSeconds`
...
**Description:** Task availability lifetime in seconds (default: 21600)

##### <a name="jobs_items_labelingTaskConfig_taskDescription"></a>1.1.4.4. Property `root > jobs > jobs items > labelingTaskConfig > taskDescription`
...
**Description:** Description of the labeling task

##### <a name="jobs_items_labelingTaskConfig_taskKeywords"></a>1.1.4.5. Property `root > jobs > jobs items > labelingTaskConfig > taskKeywords`
...
**Description:** Keywords for the labeling task
...
| Each item of this array must be                                         | Description |
| ----------------------------------------------------------------------- | ----------- |
| [taskKeywords items](#jobs_items_labelingTaskConfig_taskKeywords_items) | -           |

###### <a name="jobs_items_labelingTaskConfig_taskKeywords_items"></a>1.1.4.5.1. root > jobs > jobs items > labelingTaskConfig > taskKeywords > taskKeywords items
...
##### <a name="jobs_items_labelingTaskConfig_taskTimeLimitInSeconds"></a>1.1.4.6. Property `root > jobs > jobs items > labelingTaskConfig > taskTimeLimitInSeconds`
...
**Description:** Time limit per task in seconds (default: 300)

##### <a name="jobs_items_labelingTaskConfig_taskTitle"></a>1.1.4.7. Property `root > jobs > jobs items > labelingTaskConfig > taskTitle`
...
**Description:** Title of the labeling task shown to workers

##### <a name="jobs_items_labelingTaskConfig_templateS3Uri"></a>1.1.4.8. Property `root > jobs > jobs items > labelingTaskConfig > templateS3Uri`
...
**Description:** S3 URI for the labeling UI template (optional for built-in types)

##### <a name="jobs_items_labelingTaskConfig_workteamArn"></a>1.1.4.9. Property `root > jobs > jobs items > labelingTaskConfig > workteamArn`
...
**Description:** ARN of the workteam

#### <a name="jobs_items_sqsConfig"></a>1.1.5. Property `root > jobs > jobs items > sqsConfig`
...
| **Required**              | No                                 |
| **Additional properties** | Not allowed                        |
| **Defined in**            | #/definitions/GroundTruthSqsConfig |

**Description:** SQS configuration (optional)

| Property                                                                                | Pattern | Type   | Deprecated | Definition | Title/Description                                                    |
| --------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | -------------------------------------------------------------------- |
| - [dlqAlarmThreshold](#jobs_items_sqsConfig_dlqAlarmThreshold )                         | No      | number | No         | -          | DLQ alarm threshold (0 to disable, default: 1)                       |
| - [dlqRetentionPeriodMinutes](#jobs_items_sqsConfig_dlqRetentionPeriodMinutes )         | No      | number | No         | -          | DLQ message retention period in minutes (default: 20160 = 14 days)   |
| - [dlqVisibilityTimeoutMinutes](#jobs_items_sqsConfig_dlqVisibilityTimeoutMinutes )     | No      | number | No         | -          | DLQ visibility timeout in minutes (default: 720 = 12 hours)          |
| - [maxReceiveCount](#jobs_items_sqsConfig_maxReceiveCount )                             | No      | number | No         | -          | Max receive count before DLQ (default: 3)                            |
| - [queueRetentionPeriodMinutes](#jobs_items_sqsConfig_queueRetentionPeriodMinutes )     | No      | number | No         | -          | Queue message retention period in minutes (default: 20160 = 14 days) |
| - [queueVisibilityTimeoutMinutes](#jobs_items_sqsConfig_queueVisibilityTimeoutMinutes ) | No      | number | No         | -          | Queue visibility timeout in minutes (default: 720 = 12 hours)        |

##### <a name="jobs_items_sqsConfig_dlqAlarmThreshold"></a>1.1.5.1. Property `root > jobs > jobs items > sqsConfig > dlqAlarmThreshold`
...
**Description:** DLQ alarm threshold (0 to disable, default: 1)

##### <a name="jobs_items_sqsConfig_dlqRetentionPeriodMinutes"></a>1.1.5.2. Property `root > jobs > jobs items > sqsConfig > dlqRetentionPeriodMinutes`
...
**Description:** DLQ message retention period in minutes (default: 20160 = 14 days)

##### <a name="jobs_items_sqsConfig_dlqVisibilityTimeoutMinutes"></a>1.1.5.3. Property `root > jobs > jobs items > sqsConfig > dlqVisibilityTimeoutMinutes`
...
**Description:** DLQ visibility timeout in minutes (default: 720 = 12 hours)

##### <a name="jobs_items_sqsConfig_maxReceiveCount"></a>1.1.5.4. Property `root > jobs > jobs items > sqsConfig > maxReceiveCount`
...
**Description:** Max receive count before DLQ (default: 3)

##### <a name="jobs_items_sqsConfig_queueRetentionPeriodMinutes"></a>1.1.5.5. Property `root > jobs > jobs items > sqsConfig > queueRetentionPeriodMinutes`
...
**Description:** Queue message retention period in minutes (default: 20160 = 14 days)

##### <a name="jobs_items_sqsConfig_queueVisibilityTimeoutMinutes"></a>1.1.5.6. Property `root > jobs > jobs items > sqsConfig > queueVisibilityTimeoutMinutes`
...
**Description:** Queue visibility timeout in minutes (default: 720 = 12 hours)

#### <a name="jobs_items_taskType"></a>1.1.6. Property `root > jobs > jobs items > taskType`

|                |                                   |
| -------------- | --------------------------------- |
| **Type**       | `enum (of string)`                |
| **Required**   | Yes                               |
| **Defined in** | #/definitions/GroundTruthTaskType |

**Description:** The labeling task type
...
#### <a name="jobs_items_verification"></a>1.1.7. Property `root > jobs > jobs items > verification`
...
| **Required**              | No                                          |
| **Additional properties** | Not allowed                                 |
| **Defined in**            | #/definitions/GroundTruthVerificationConfig |

**Description:** Optional verification step configuration

| Property                                                                                           | Pattern | Type            | Deprecated | Definition | Title/Description                                          |
| -------------------------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ---------------------------------------------------------- |
| - [categoriesS3Uri](#jobs_items_verification_categoriesS3Uri )                                     | No      | string          | No         | -          | S3 URI for the verification categories file                |
| - [numberOfHumanWorkersPerDataObject](#jobs_items_verification_numberOfHumanWorkersPerDataObject ) | No      | number          | No         | -          | Workers per data object for verification (default: 1)      |
| - [taskAvailabilityLifetimeInSeconds](#jobs_items_verification_taskAvailabilityLifetimeInSeconds ) | No      | number          | No         | -          | Task availability lifetime in seconds (default: 21600)     |
| + [taskDescription](#jobs_items_verification_taskDescription )                                     | No      | string          | No         | -          | Description of the verification task                       |
| - [taskKeywords](#jobs_items_verification_taskKeywords )                                           | No      | array of string | No         | -          | Keywords for the verification task                         |
| - [taskTimeLimitInSeconds](#jobs_items_verification_taskTimeLimitInSeconds )                       | No      | number          | No         | -          | Time limit per verification task in seconds (default: 300) |
| + [taskTitle](#jobs_items_verification_taskTitle )                                                 | No      | string          | No         | -          | Title of the verification task                             |
| - [templateS3Uri](#jobs_items_verification_templateS3Uri )                                         | No      | string          | No         | -          | S3 URI for the verification UI template                    |
| + [workteamArn](#jobs_items_verification_workteamArn )                                             | No      | string          | No         | -          | ARN of the verification workteam                           |

##### <a name="jobs_items_verification_categoriesS3Uri"></a>1.1.7.1. Property `root > jobs > jobs items > verification > categoriesS3Uri`
...
**Description:** S3 URI for the verification categories file

##### <a name="jobs_items_verification_numberOfHumanWorkersPerDataObject"></a>1.1.7.2. Property `root > jobs > jobs items > verification > numberOfHumanWorkersPerDataObject`
...
**Description:** Workers per data object for verification (default: 1)

##### <a name="jobs_items_verification_taskAvailabilityLifetimeInSeconds"></a>1.1.7.3. Property `root > jobs > jobs items > verification > taskAvailabilityLifetimeInSeconds`
...
##### <a name="jobs_items_verification_taskDescription"></a>1.1.7.4. Property `root > jobs > jobs items > verification > taskDescription`
...
##### <a name="jobs_items_verification_taskKeywords"></a>1.1.7.5. Property `root > jobs > jobs items > verification > taskKeywords`
...
**Description:** Keywords for the verification task
...
| Each item of this array must be                                   | Description |
| ----------------------------------------------------------------- | ----------- |
| [taskKeywords items](#jobs_items_verification_taskKeywords_items) | -           |

###### <a name="jobs_items_verification_taskKeywords_items"></a>1.1.7.5.1. root > jobs > jobs items > verification > taskKeywords > taskKeywords items
...
##### <a name="jobs_items_verification_taskTimeLimitInSeconds"></a>1.1.7.6. Property `root > jobs > jobs items > verification > taskTimeLimitInSeconds`
...
**Description:** Time limit per verification task in seconds (default: 300)

##### <a name="jobs_items_verification_taskTitle"></a>1.1.7.7. Property `root > jobs > jobs items > verification > taskTitle`
...
**Description:** Title of the verification task

##### <a name="jobs_items_verification_templateS3Uri"></a>1.1.7.8. Property `root > jobs > jobs items > verification > templateS3Uri`
...
**Description:** S3 URI for the verification UI template

##### <a name="jobs_items_verification_workteamArn"></a>1.1.7.9. Property `root > jobs > jobs items > verification > workteamArn`
...
**Description:** ARN of the verification workteam

#### <a name="jobs_items_workflowSchedule"></a>1.1.8. Property `root > jobs > jobs items > workflowSchedule`
...
**Description:** Cron schedule for the workflow (default: "cron(0 12 * * ? *)")
...
| + [provisioningRole](#sagemakerBlueprint_provisioningRole )           | No      | object          | No         | Same as [groundTruthRole](#jobs_items_groundTruthRole ) | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| + [provisioningRole](#sagemakerBlueprint_additionalAccounts_additionalProperties_provisioningRole )           | No      | object          | No         | Same as [groundTruthRole](#jobs_items_groundTruthRole ) | -                 |
...
| **Required**              | Yes                                            |
| **Additional properties** | Not allowed                                    |
| **Same definition as**    | [groundTruthRole](#jobs_items_groundTruthRole) |
