...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [deploy](#deploy )                                                 | No      | object | No         | In #/definitions/SageMakerMLOpsDeployConfig         | Deployment pipeline configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| + [training](#training )                                             | No      | object | No         | In #/definitions/SageMakerMLOpsTrainingConfig       | Training pipeline configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

## <a name="deploy"></a>1. Property `root > deploy`
...
| **Required**              | Yes                                      |
| **Additional properties** | Not allowed                              |
| **Defined in**            | #/definitions/SageMakerMLOpsDeployConfig |
...
| **Required**              | No                                     |
| **Additional properties** | Not allowed                            |
| **Defined in**            | #/definitions/CodeStarConnectionConfig |

**Description:** CodeStar Connections config for the deploy repo

| Property                                                     | Pattern | Type   | Deprecated | Definition | Title/Description                                                      |
| ------------------------------------------------------------ | ------- | ------ | ---------- | ---------- | ---------------------------------------------------------------------- |
| - [branch](#deploy_codeStarConnection_branch )               | No      | string | No         | -          | Branch to track (default: 'main')                                      |
| + [connectionArn](#deploy_codeStarConnection_connectionArn ) | No      | string | No         | -          | ARN of the AWS CodeStar Connection (created in AWS Console or via CLI) |
...
| **Required**              | No                                    |
| **Additional properties** | Not allowed                           |
| **Defined in**            | #/definitions/DeployEnvironmentConfig |

**Description:** Dev environment config

| Property                                                       | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                             |
| -------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------- |
| - [accountId](#deploy_devEnvironment_accountId )               | No      | string          | No         | -          | AWS account ID — required for cross-account deployment (preProd/prod), ignored for dev (uses current account) |
| - [region](#deploy_devEnvironment_region )                     | No      | string          | No         | -          | AWS region — required for cross-account deployment (preProd/prod), ignored for dev (uses current region)      |
| - [securityGroupIds](#deploy_devEnvironment_securityGroupIds ) | No      | array of string | No         | -          | Security group IDs for endpoint deployment — optional regardless of environment                               |
...
**Description:** Security group IDs for endpoint deployment — optional regardless of environment
...
**Description:** Subnet IDs for endpoint deployment — optional regardless of environment
...
| **Required**              | No                                       |
| **Additional properties** | Not allowed                              |
| **Same definition as**    | [devEnvironment](#deploy_devEnvironment) |
...
**Description:** Source repository type (default: CODECOMMIT)
...
## <a name="training"></a>5. Property `root > training`
...
| **Required**              | Yes                                        |
| **Additional properties** | Not allowed                                |
| **Defined in**            | #/definitions/SageMakerMLOpsTrainingConfig |
...
| **Required**              | No                                               |
| **Additional properties** | Not allowed                                      |
| **Same definition as**    | [codeStarConnection](#deploy_codeStarConnection) |
...
| **Required**              | No                                           |
| **Additional properties** | Not allowed                                  |
| **Defined in**            | #/definitions/ModelTrainingEnvironmentConfig |

**Description:** Dev environment config (VPC, subnets, security groups)

| Property                                                         | Pattern | Type            | Deprecated | Definition | Title/Description                              |
| ---------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ---------------------------------------------- |
| - [securityGroupIds](#training_devEnvironment_securityGroupIds ) | No      | array of string | No         | -          | Security group IDs for SageMaker training jobs |
...
**Description:** Security group IDs for SageMaker training jobs
...
**Description:** Path to a local directory containing training data files to upload to the pipeline S3 bucket during deploy.
